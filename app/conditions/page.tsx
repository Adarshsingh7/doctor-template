      ...
      <section className="bg-primary-container py-24">
        <div className="px-margin-desktop max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <img alt="Doctor consulting patient" className="rounded-xl shadow-2xl relative z-10 grayscale-[30%]" src={symptomChecker.image} />
          </div>
          <div>
            ...
            <div className="space-y-6">
              {symptomChecker.items.map((item, idx) => (
                <div key={idx} className="flex gap-6 p-6 bg-white/5 rounded-lg border border-white/10">
