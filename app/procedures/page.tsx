    ...
    <>
      <section className="py-24 px-margin-desktop max-w-container-max mx-auto bg-surface">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          {/* Neural Navigation */}
          <div className="md:col-span-8 bg-surface-container-low p-8 rounded-xl border border-outline-variant/10 relative overflow-hidden flex flex-col justify-between min-h-[320px]">
            <div>
          ...
          {/* Robotics Status */}
          <div className="md:col-span-4 bg-primary p-8 rounded-xl text-white flex flex-col justify-between min-h-[320px]">
            <div>
        ...
        <div className="px-margin-desktop max-w-container-max mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter relative">
            ...
            {patientSafety.steps.map((step, idx) => (
              <div key={idx} className="bg-white/5 border border-white/10 p-8 rounded-xl backdrop-blur-sm relative z-10">
